...
class Translator():
	...
	def __init__(self):
		...
		self.cache_file = '/home/stuart/Documents/masters_project/language_app_first_draft/google_translate/translation_cache.json'
		self.characters_translated, self.characters_saved = self._get_character_data()

	def _get_api_key(self):
		with open('./google_translate/api.key') as key:
